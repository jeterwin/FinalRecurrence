...
public class Checkpoint5 : MonoBehaviour
{
    ...
    public GameObject saveGame, player;
    bool hasPlayed = false;
    private void Start()
    {
        if (SaveManager.instance.hasLoaded)
        {
            if (SaveManager.instance.activeSave.checkpoint6 == true)
            {
    ...
    {
        GameManager.instance.respawnPoint = player.transform.position;

        SaveManager.instance.activeSave.respawnPosition = player.transform.position;
        SaveManager.instance.activeSave.checkpoint6 = true;
